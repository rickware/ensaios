...
if ($debug) {
  ob_start();
  fb('Relatorio clientes', FirePHP::INFO);
}
...
<html>
  <head>
    ...
    <title>Projeto 1 - Relat&oacute;rio Clientes</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="table-wrapper">
        <div class="table-title">
          <div class="row">
            <div class="col-sm-6">
              <h2>Relat&oacute;rio <b>Clientes</b></h2>
            </div>
            <div class="col-sm-6">
    ...
    <script>
      function salvar() {
        location.replace("./backend/pdf_clientes.php");
      }
    </script>
  </body>
</html>
