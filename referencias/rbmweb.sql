...
--
-- Host: localhost
-- Generation Time: Dec 01, 2021 at 03:53 PM
...
CREATE TABLE `pedidos` (
  ...
  `data_do_pedido` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `produtos` (
  `id` int NOT NULL,
  `codigo` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `nome` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `preco` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `unidade` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `categoria` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
ALTER TABLE `clientes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `nomes_tel` (`nome`(5),`celular`(3));
...
ALTER TABLE `pedidos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cliente` (`cliente_id`) USING BTREE,
  ADD KEY `data_pedido` (`data_do_pedido`);
...
ALTER TABLE `pedido_detalhes`
  ...
  ADD KEY `fk_order_details_orders1_idx` (`pedido_id`);
...
--
ALTER TABLE `pedido_detalhes`
  ADD CONSTRAINT `pedido_detalhes_ibfk_1` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`) ON DELETE CASCADE;
COMMIT;
